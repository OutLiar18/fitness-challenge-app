...
function PrivatePanel({ notificationsState, actionError, setActionError }) {
...
export default function Inbox() {
  ...
  const totalUnread = announcementsState.unreadCount + notificationsState.unreadCount;
    ...
    <div className="inbox-page page-stack">
      ...
      <section className="inbox-overview card" aria-label="Inbox summary">
        <div>
          ...
          <small>{pluralize(totalUnread, "unread message", "unread messages")}</small>
        </div>
      ...
      <div className="inbox-tabs" role="tablist" aria-label="Inbox sections">
        ...
        >
          <span aria-hidden="true">🔒</span>
          Private
          {notificationsState.unreadCount > 0 && <strong>{notificationsState.unreadCount}</strong>}
        </button>
      </div>
