...
This document defines the Git workflow used throughout Champions Legacy Challenge.
...
It is the historical record of how Champions Legacy Challenge has evolved.
...
The `main` branch always represents the latest stable version of Champions Legacy Challenge.
