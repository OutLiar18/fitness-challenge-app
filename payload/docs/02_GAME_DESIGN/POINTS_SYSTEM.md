...
# Current Implemented Bonus Points — v0.7.0
...
The Points System defines how Champions Legacy Challenge recognises meaningful effort.
...
- Supply data to the wider Champions Legacy Challenge ecosystem.

The Points System is one component of the Champions Legacy Challenge Scoring Engine.
...
Champions Legacy Challenge is built upon a simple belief:
...
Champions Legacy Challenge promotes improvement across multiple aspects of life.
...
This shared pipeline keeps behaviour consistent across every category within Champions Legacy Challenge.

---

# Facts vs Calculations

One of the most important architectural principles within Champions Legacy Challenge is the separation of recorded facts from calculated values.
...
Unlike daily points, XP represents a player's continuing journey through Champions Legacy Challenge.
...
Every activity recorded within Champions Legacy Challenge should strengthen multiple systems simultaneously.
...
Champions Legacy Challenge handles the rest.
...
Rather than creating unique scoring logic for every activity, Champions Legacy Challenge groups activities into a small number of reusable scoring models.
...
As Champions Legacy Challenge grows, categories should evolve through configuration rather than new business logic.
...
For this reason, Champions Legacy Challenge does not attempt to perfectly measure human effort.
...
This separation allows Champions Legacy Challenge to grow without continually modifying the underlying scoring engine.

---

# Configuration Over Code

One of the guiding principles of Champions Legacy Challenge is that balancing should not require rewriting business logic.
...
Every activity recorded within Champions Legacy Challenge should pass through the same scoring engine.
...
Champions Legacy Challenge embraces the principle of progressive complexity.
...
Rather than attempting to detect every possible exploit, Champions Legacy Challenge is designed to minimise the incentive to abuse the system.
...
Champions Legacy Challenge automatically updates:
...
The Points System supports every major progression mechanic within Champions Legacy Challenge.
...
The purpose of the Champions Legacy Challenge Points System is not to determine who is the strongest, fastest or smartest.
