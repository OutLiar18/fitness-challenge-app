...
# Derived Personal Progress — v0.7.0
...
This document defines the core entities that make up Champions Legacy Challenge and the relationships between them.
...
- Each entity represents a real concept within Champions Legacy Challenge.
...
Represents a person using Champions Legacy Challenge.
...
Entries are the primary source of progression within Champions Legacy Challenge.
...
## Local Avatar Reference

`User.avatarId` references the application-bundled Legacy Avatar catalogue. It is a stable identifier rather than media data. This keeps identity portable while avoiding storage coupling.
