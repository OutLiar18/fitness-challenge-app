...
- Editable player profiles with built-in Legacy Avatars and no media uploads.
- Announcements with filters, local read status and navigation badges.
...
- Twenty-nine automated domain and architecture tests.
