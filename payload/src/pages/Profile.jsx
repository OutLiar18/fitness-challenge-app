      ...
      {status && (
        <div
          className={`inline-alert inline-alert--${
            status.type === "error" ? "danger" : status.type === "success" ? "success" : "info"
          }`}
  ...
  return (
    <div className="profile-page page-stack">
      ...
      <section className="profile-preferences card">
        <div>
          <p>Coming later</p>
          <h2>Privacy, accessibility and notifications</h2>
          <p>
      ...
      <section className="profile-easter-egg card">
        ...
        <div>
          ...
          <p>
            The avatar is decorative. The actual superpower remains showing up when
            motivation has mysteriously left the group chat.
          </p>
        </div>
      </section>
    </div>
