  ...
  return (
    <main className="auth-page">
      <div className="auth-shell">
        <section className="auth-brand" aria-label="Champions Legacy Challenge">
          <div className="auth-brand__mark"><span>🏆</span><span>Champions Legacy Challenge</span></div>
        ...
        <section className="auth-panel">
          ...
          <p className="auth-panel__switch">New to Champions Legacy Challenge? <Link to="/signup">Create an account</Link></p>
        </section>
      </div>
    </main>
  );
