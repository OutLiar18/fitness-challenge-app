...
Historical ADRs remain records even when superseded. The main v0.19.0 updater includes all documentation and an in-package release finaliser; do not create a separate documentation-sync archive.
