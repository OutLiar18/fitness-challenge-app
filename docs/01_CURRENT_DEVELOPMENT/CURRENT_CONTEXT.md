...
28D1 is now implemented in source version 0.28.0 and awaits owner visual/responsive review. It adds the shared interaction affordance foundation, Dashboard transmission/avatar/action/goal/XP changes, concise desktop shell stats and all-caps brand treatment, direct mobile Seasons/Houses access with Inbox preserved through More, and direct Today/Yesterday Log Activity controls plus Action Centre/copy cleanup. Firestore Rules remain unchanged; no production deployment.