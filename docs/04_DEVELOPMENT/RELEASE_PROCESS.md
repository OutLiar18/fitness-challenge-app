...
v0.13.1 is the official-reference pre-review foundation, not v1.0. Do not create a v1.0 tag until the user explicitly approves the final visual, gameplay and operational scope.
